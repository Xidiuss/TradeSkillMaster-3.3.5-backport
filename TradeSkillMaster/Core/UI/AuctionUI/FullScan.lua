...
local DUP_REQUERY_DELAY = 0.3 -- пауза перед повтором echo-страницы (снижено с 0.5)
...
local EMPTY_PAGE_RETRY_DELAY = 0.5 -- пауза перед повтором пустой страницы (снижено с 1.0)
